        ...
        <div class="col-md-6">
            ...
            <form action="<?=$_SERVER['REQUEST_URI']?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nominal" name="nominal" value="<?= $_POST['nominal'] ? $_POST['nominal'] : $transaction['nominal'] ?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="datetime-local" class="form-control" id="due_date" name="due_date"  value="<?= dateRfc3309($transaction['transaction_at']) ?>" >
                </div>
                <input type="hidden" name="type" value="<?= $where ?>">
                <input type="hidden" name="action" value="create_trx_edit">
